...
/*      arrays for the DSP_fft32x32, DSP_fft32x32s and DSP_ifft33x32 FFT    */
/*      library routines.  It is called as follows:                         */
/*                                                                          */
/*          tw_fft32x32 [-s scale] N > outputfile.c                         */
/*                                                                          */
...
/*      functions DSP_fft32x32, DSP_fft32x32s and DSP_ifft16x32.  This      */
/*      code may not produce an appropriate twiddle-factor array for the    */
/*      other DSPLIB FFT functions.                                         */
/*                                                                          */
        ...
        if (**++argv == '-' || **argv == '/')
        {
            switch (argv[0][1])
            {
                case 's' : case 'S' :
                {
                    ...
                    if (scale <= 0.0 || scale > 2147483647.6)
...
"/*      Number of points:    %-5d                                      */\n"
"/*      Scale factor:        %-20.9f                       */\n"
"/*      Appropriate FFTs:    DSP_fft32x32, DSP_fft32x32s, DSP_ifft32x32 */\n"
